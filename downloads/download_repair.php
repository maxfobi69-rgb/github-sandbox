...
<meta name="msapplication-TileImage" content="favicon.png">
  <link href="//static.mediafire.com/css/mfv3_121967.php?ver=nonssl" rel="stylesheet" type="text/css"/> <link href="//static.mediafire.com/css/mfv4_121967.php?ver=nonssl&date=2026-05-06" rel="stylesheet" type="text/css"/>  <link href='https://fonts.googleapis.com/css?family=Open+Sans:800,700,400,300' rel='stylesheet' type='text/css'/>  <!--[if lte IE 8]> <link rel="stylesheet" type="text/css" href="//static.mediafire.com/css/ie.css_121967.php?ver=nonssl"/> <![endif]--> <!--[if lt IE 7]> <link rel="stylesheet" type="text/css" href="//static.mediafire.com/css/ie6.css_121967.php?ver=nonssl"/> <![endif]--> <!--[if IE 7]> <link rel="stylesheet" type="text/css" href="//static.mediafire.com/css/ie7.css_121967.php?ver=nonssl"/> <![endif]-->  <link rel="icon" href="/favicon.ico"/>  <script>
    // Recaptcha event bus
...
<script src="https://www.google.com/recaptcha/api.js?onload=onMfRecaptchaLoad&render=explicit" async defer></script> <script type="text/javascript">var acK= true;var aCH='live';var aWJ= false;function asO(e,qv){var vU=qv+': ';if(e.name){vU+='Error name: "'+e.name+'"  ';}if(e.message){vU+='Error message: "'+e.message+'"  ';}Ku(5,vU);};var Iu='File sharing and storage made simple'; </script>  <script type="text/javascript" src="http://ajax.googleapis.com/ajax/libs/jquery/1.7.2/jquery.min.js"> </script>  <script language="JavaScript" type="text/JavaScript">try{if(typeof jQuery=="undefined"){document.write('<scri'+'pt type="text/javascript" src="//static.mediafire.com/js/jquery/1.7.2/jquery.min.js"></sc'+'ript>');}}catch(e){asO(e,'HDR:jquery_check');} </script>   <style type="text/css">  </style> <script type="text/javascript">var JS_LoadTime= 121967;var sDefaultShareLinkProtocol='https';window.onload=function(){Cy();}; </script>  
    ...
    <script>
        try {
            ...
            gtag("js", new Date());
            gtag("config", "UA-829541-1", {"dimension1":"unregistered","dimension7":"legacy","dimension8":"\/20\/50\/100\/"});
        } catch(e) {}
    </script>
    ...
    <div id="captcha_msg">
        ...
        <div class="DownloadRepair-captchaComplete">
            ...
            <p id="captcha_complete_alt" style="display: none;">
                If your download does not start, <a href="/file/h5m8k0iicb8d4zu/Phyre_Engine.7z/file" id="captcha_complete_link">click here</a>.
            </p>
        </div>
    </div>
</div>
...
</script><form id="recaptchaForm" action="/file/h5m8k0iicb8d4zu/Phyre_Engine.7z/file" method="post" style="display: none;">
...
<script>
    ...
    mfRecaptchaBus.addEventListener('solved', function(data) {
        ...
        // New page
        let downloadPageSolved = '/file/h5m8k0iicb8d4zu/Phyre_Engine.7z/file?g-recaptcha-response=' + encodeURIComponent(data.detail.token);
        let downloadPageNotLoading = '/file/h5m8k0iicb8d4zu/Phyre_Engine.7z/file?captcha-failure=1';
...
<script type="text/javascript">
 ...
 <script>(function(){function c(){var b=a.contentDocument||a.contentWindow.document;if(b){var d=b.createElement('script');d.innerHTML="window.__CF$cv$params={r:'9f7702e9ab932ab9',t:'MTc3ODA2MDI5OQ=='};var a=document.createElement('script');a.src='/cdn-cgi/challenge-platform/scripts/jsd/main.js';document.getElementsByTagName('head')[0].appendChild(a);";b.getElementsByTagName('head')[0].appendChild(d)}}if(document.body){var a=document.createElement('iframe');a.height=1;a.width=1;a.style.position='absolute';a.style.top=0;a.style.left=0;a.style.border='none';a.style.visibility='hidden';document.body.appendChild(a);if('loading'!==document.readyState)c();else if(window.addEventListener)document.addEventListener('DOMContentLoaded',c);else{var e=document.onreadystatechange||function(){};document.onreadystatechange=function(b){e(b);'loading'!==document.readyState&&(document.onreadystatechange=e,c())}}}})();</script></body> </html>